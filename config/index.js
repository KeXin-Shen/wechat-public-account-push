export const USER_CONFIG = {
  ...
  USERS: [
    {
      ...
      id: "",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "TTiwIbTsCb0Re_HldbOR3jXY9iZe9kNYtSskFGxO7_w",
      // 所在省份
      province: "天津
      // 所在城市
      city: "塘沽",
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "仙女小王", "year": "2002","date":"11-20"},
        {"type": "节日", "name": "在一起已经", "year": "2021", "date": "07-05"},
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {"type": "生日", "name": "仙女小王", "year": "2002", "date": "12-13"},
        {"type": "节日", "name": "易烊千玺生日", "year": "2000", "date": "11-28"},
      ],
  ...
  CALLBACK_TEMPLATE_ID: "TTiwIbTsCb0Re_HldbOR3jXY9iZe9kNYtSskFGxO7_w",
  ...
  CALLBACK_USERS: [
    {
      ...
      id: "omjpR5y1GhuE3jJ4MUEV1BpBBWnc",
    },
    // 你可以不断按格式往下增加
    // ...
  ],
  ...
  SLOT_LIST: [
    // 这样配置的话，就会每次发送这句话
    {"keyword": "encourage_oneself", contents: "每天都是元气满满的一天"},
    // 这样配置的话，就会每次随机选一句话发送
